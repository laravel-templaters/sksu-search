                            ...
                            <td class="flex items-center px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center py-2">
                                    ...
                                    <div class="text-sm text-red-600" x-data = "{modalReject{{1}}open: false}">
                                        ...
                                        aria-labelledby="modal-title" role="dialog" aria-modal="true" x-show="modalReject{{1}}open" x-cloak>
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                                                    <div class="sm:flex sm:items-start">
                                                        ...
                                                        <div
                                                            class="mt-3 text-center whitespace-normal sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"x-on:click="modalReject{{1}}open=false">
                                                        Cancel
                                                    </button>
                                                </div>
                                            </div>
