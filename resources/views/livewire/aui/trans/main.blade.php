<div class="flex flex-col" x-data="{isopen : @entangle('isopen')}">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-900"> 2021/08/17
                            ...
                            <td class="text-sm text-gray-900">
                                {{-- buttons start --}}
                                <button wire:click.prevent="openViewModal({{1}})">
    ...
    <div x-cloak class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        aria-modal="true" x-show="isopen">
                        ...
                        <div class="items-baseline mt-3">
                            <ul class="">
                                ...
                                <div class="" x-data="{doc{{1}}isopen: false}">
                                    <li class="flex">
                                        <span>
                                            Document Name HERE dvID passed ---> {{$dvID}}
                                        </span>
                                        <button class="" x-on:click="doc{{1}}isopen = ! doc{{1}}isopen">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="w-6 h-6 pl-2 text-indigo-700 " fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
