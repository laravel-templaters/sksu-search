        ...
        <dl class="grid grid-cols-1 gap-5 mt-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="relative px-4 pt-5 overflow-hidden rounded-lg shadow sm:pt-6 sm:px-6 bg-blue-53">
                <dt>
                    <div class="absolute p-3 mx-auto bg-transparent rounded-md">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex w-10 h-10 text-blue-52 item-center" fill="none"
            ...
            <div class="relative px-4 pt-5 overflow-hidden rounded-lg shadow sm:pt-6 sm:px-6 bg-blue-53">
                <dt>
                    <div class="absolute p-3 mx-auto bg-transparent rounded-md">
                        <!-- Heroicon name: outline/users -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex w-10 h-10 text-blue-52 item-center" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                    </div>
                    <p class="ml-16 text-lg font-medium text-white truncate">Disbursement Vouchers</p>
                </dt>
                <dd class="flex items-baseline pb-6 ml-16 sm:pb-7">
                    <p class="text-2xl font-semibold text-blue-52">
                        71,897
            ...
            <div class="relative px-4 pt-5 overflow-hidden rounded-lg shadow sm:pt-6 sm:px-6 bg-blue-53">
                <dt>
                    ...
                    <p class="ml-16 text-lg font-medium text-white truncate">Active Users</p>
                </dt>
                <dd class="flex items-baseline pb-6 ml-16 sm:pb-7">
                    <p class="text-2xl font-semibold text-blue-52">
                        71,897
